# Generated by Django 4.2.15 on 2024-08-17 14:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Student',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='eLearning_app.user')),
            ],
        ),
        migrations.CreateModel(
            name='Teacher',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eLearning_app.user')),
            ],
        ),
        migrations.CreateModel(
            name='ChatRoom',
            fields=[
                ...
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eLearning_app.user')),
                ('members', models.ManyToManyField(related_name='chat_rooms', to='eLearning_app.user')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eLearning_app.course')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eLearning_app.student')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher', to='eLearning_app.teacher')),
            ],
        ),
        migrations.AddField(
            model_name='course',
            name='students',
            field=models.ManyToManyField(blank=True, related_name='enrolled_courses', to='eLearning_app.student'),
        ),
        migrations.AddField(
            model_name='course',
            name='teacher',
